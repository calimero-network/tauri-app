...
export interface PackageAsset {
   ...
   * origin is running the app, not the registry, so every preview renders
   * broken. Resolved once here so no caller can forget.
   */
  url?: string;
  /**
...
/**
 * Preview images for a package, ready to render.
 *
